...
const plans = [
  { name: "Gratuit", nameEn: "Free", price: "0€", sub: "Pour découvrir", subEn: "To discover", badge: null, features: ["1 idée générée gratuite", "Aperçu 3 pays", "Structures juridiques basiques", "Accès limité"], featuresEn: ["1 free generated idea", "Preview 3 countries", "Basic legal structures", "Limited access"], cta: "Commencer", ctaEn: "Start", grad: `linear-gradient(135deg, #6B7280, #9CA3AF)`, plan: "free", lsLink: "https://innovationatlas.lemonsqueezy.com" },
  { name: "Pro", nameEn: "Pro", price: "79€", sub: "/mois", subEn: "/month", badge: " POPULAIRE", features: ["Idées illimitées (30 jours)", "10 guides pays complets", "Comparateur avancé", "Simulateur de coûts", "Calculateur fiscal", "Checklist interactive", "Export PDF"], featuresEn: ["Unlimited ideas (30 days)", "10 complete country guides", "Advanced comparator", "Cost simulator", "Tax calculator", "Interactive checklist", "PDF export"], cta: "Choisir Pro", ctaEn: "Choose Pro", grad: `linear-gradient(135deg, ${C.violet}, ${C.blue})`, plan: "pro", lsLink: "https://innovationatlas.lemonsqueezy.com/buy/pro" },
  { name: "Ultimate", nameEn: "Ultimate", price: "149€", sub: "paiement unique", subEn: "one-time payment", badge: "MEILLEUR", features: ["Tout illimité à VIE", "Tous les pays (15+)", "Templates business plan", "Support prioritaire 24/7", "Mises à jour gratuites", "Consultat
